...
_model_sha1 = {name: checksum for checksum, name in [
    ...
    ('966fb78c22323b0c68097c5c1242bd16d3e07fd5', 'resnet101'),
...
_url_format = 'https://s3.us-west-1.wasabisys.com/encoding/models/{}.zip'
enc_model_urls = {
    'resnet50': _url_format.format('resnet50s-'   + _model_sha1['resnet50' ][:8]),
