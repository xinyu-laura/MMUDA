...
from seg_lawin_head import LawinHead
import seg_mix
...
class segformer_lawin(nn.Module):
    def __init__(self, backbone, num_classes=20, embedding_dim=768, pretrained=None):
        ...
        self.decoder = LawinHead(feature_strides=self.feature_strides, in_channels=self.in_channels, num_classes=self.num_classes)
